...
import { PrismaClubCoachReader } from "../../infrastructure/queries/club-coaches.query";
import { ListClubScientistsUseCase } from "../../application/use-cases/list-club-scientists.use-case";
import { PrismaClubScientistReader } from "../../infrastructure/queries/club-scientists.query";
import { ListClubConditioningUseCase } from "../../application/use-cases/list-club-conditioning.use-case";
import { PrismaClubConditioningReader } from "../../infrastructure/queries/club-conditioning.query";
import { ListClubNutritionUseCase } from "../../application/use-cases/list-club-nutrition.use-case";
import { PrismaClubNutritionReader } from "../../infrastructure/queries/club-nutrition.query";
import { ListClubRehabilitationUseCase } from "../../application/use-cases/list-club-rehabilitation.use-case";
import { PrismaClubRehabilitationReader } from "../../infrastructure/queries/club-rehabilitation.query";
import { ListClubAthletesUseCase } from "../../application/use-cases/list-club-athletes.use-case";
import { PrismaClubAthletesReader } from "../../infrastructure/queries/club-athletes.query";
...
const workoutProgrammeController =
    new WorkoutProgrammeController(
        ...
        workoutProgrammeModule.updateTrainerSessionWorkflowUseCase,
...
const coachSquadController =
    new CoachSquadController(
        ...
        coachModule.getCoachSquadTrainingLoadUseCase,
        coachModule.getCoachSquadAthleteDevelopmentUseCase,
    );

const coachTeamController = new CoachTeamController(
    coachModule.createCoachTeamUseCase,
    coachModule.listCoachTeamsUseCase,
    coachModule.updateCoachTeamUseCase,
);
const coachAthleteController =
    new CoachAthleteController(
        coachModule.addMyCoachAthleteUseCase,
...
router.use("/club", createClubRoutes(
    ...
    new ListClubCoachesUseCase(new PrismaClubCoachReader(new DatabaseService())),
    new ListClubScientistsUseCase(new PrismaClubScientistReader(new DatabaseService())),
    ...
    new ListClubAthletesUseCase(new PrismaClubAthletesReader(new DatabaseService())),
));
router.use(
    ...
    createPerformanceDirectorRoutes(
        ...
        new GetDepartmentRoleReportUseCase(
            new PrismaDepartmentCommandCentreReader(new DatabaseService()),
            new PrismaDepartmentPerformanceIntelligenceReader(new DatabaseService()),
        ),
        new GetDepartmentDecisionSupportUseCase(
            new PrismaDepartmentPerformanceIntelligenceReader(new DatabaseService()),
        ),
    ),
);
