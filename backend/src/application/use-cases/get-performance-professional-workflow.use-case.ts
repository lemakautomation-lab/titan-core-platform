...
import { GetPerformanceProfessionalWorkflowQuery } from "../queries/performance-professional/get-performance-professional-workflow.query";
import {
    PerformanceProfessionalObservationDto,
    PerformanceProfessionalWorkflowDto,
} from "../dto/performance-professional/performance-professional-workflow.dto";
...
export class GetPerformanceProfessionalWorkflowUseCase {
    constructor(
    ...
    async execute(
        query: Readonly<GetPerformanceProfessionalWorkflowQuery>,
    ): Promise<Result<PerformanceProfessionalWorkflowDto>> {
        if (
        ...
        return Result.success({
            ...
            performance,
            recovery: recovery.map(this.mapObservation),
            trainingStress: trainingStress.map(this.mapObservation),
