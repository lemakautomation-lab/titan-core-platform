...
describe(
    "Mission 064.8 - Trainer client reports API",
    () => {
        beforeEach(async () => {
        ...
        it(
            "rejects unauthenticated reporting",
            async () => {
                const response =
                    await request(app)
                        .get(
                            "/api/v1/workout-programmes/trainer/clients/athlete-id/report",
                        );
        ...
        it(
            "rejects reporting without an active Trainer-client relationship",
            async () => {
                const {
                    user,
                    password,
        ...
        it(
            "returns a factual report for an active Trainer client",
            async () => {
                const {
                    user,
                    password,
                ...
                try {
                    ...
                    const response =
                        await request(app)
                            .get(
                                `/api/v1/workout-programmes/trainer/clients/${athlete.id}/report?limit=1`,
                            )
                            .set(
                                "Authorization",
                                `Bearer ${token}`,
