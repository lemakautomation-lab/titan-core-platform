  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          authState === "authenticated" ? (
            <Navigate to={getAuthenticatedLandingRoute(user)} replace />
          ) : (
            <SignupChoicePage />
          )
        }
          ...
          element={
            <RequirePermission user={user} permission="club.executives.read">
              <ClubPage
                ...
                canReadTeams={Boolean(user?.permissions.includes("club.teams.read"))}
                canReadAthletes={Boolean(user?.permissions.includes("club.athletes.read"))}
              />
            </RequirePermission>
          }
        />
